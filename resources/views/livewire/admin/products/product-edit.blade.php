                ...
                <div class="p-6">
                    <form action="" enctype="multipart/form-data">
                        <div class="w-full mb-6">
                            ...
                            <input type="text" wire:model.live="product.name" class="w-full rounded ">
                            @error('product.name')
                        ...
                        <div  class="w-full mb-6">
                            ...
                            <input type="text" wire:model.live="product.description" class="w-full rounded ">
                        ...
                        <div class="w-full mb-6">
                            ...
                            <textarea id="" cols="30" rows="10" wire:model.live="product.body" class="w-full rounded "></textarea>
                            @error('product.body')
                            <div class="w-full p-4 mt-4 rounded border border-red-900 bg-red-400 text-white font-bold">
                                {{$message}}
                            </div>
                        ...
                        <div class="w-full mb-6">
                            ...
                            <input type="text" wire:model.live="product.price" class="w-full rounded ">
                            @error('product.price')
                            <div class="w-full p-4 mt-4 rounded border border-red-900 bg-red-400 text-white font-bold">
                                {{$message}}
                            </div>
                        ...
                        <div class="w-full mb-6 flex justify-between">
                            ...
                            <div class="w-1/2 p-2">
                                ...
                                <input type="file" wire:model.live="photo" class="w-full rounded border border-gray-400 p-2">
                                @error('product.photo')
                                <div class="w-full p-4 mt-4 rounded border border-red-900 bg-red-400 text-white font-bold">
                                    {{$message}}
                                </div>
                        ...
                        <button wire:click.prevent="updateProduct"
